...
def load_args():
    ...
    parser.add_argument('--param_n', type=int, default=None, help="trial number of training parameters")
...
def main():
    ...
    init_wandb(periperal, timestamp, LR, N_LAYERS, DROPOUT, D_MODEL, N_HEADS)
